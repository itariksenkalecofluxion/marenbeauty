...
| "Sonrasında" | `aftercare[]` | Practical aftercare notes |
| "Süre" | `durationLabel` | **Renders nothing while `null`** — no guess, no dash |
...
Target length: **500–800 words** of body prose. Long enough to be genuinely
useful, short enough to stay honest.
